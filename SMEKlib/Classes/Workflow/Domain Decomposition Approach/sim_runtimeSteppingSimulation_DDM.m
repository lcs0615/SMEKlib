% ===================== 中文教学注释 =====================
% 文件路径: Classes/Workflow/Domain Decomposition Approach/sim_runtimeSteppingSimulation_DDM.m
...
for kt = 2:Nsamples
    ...
    if kt == 3
        sim.misc.Fa = P_m2D'*reshape(hconst2(1:ND,:), [], 1);
        sim.misc.Fi = L_s' * reshape(hconst2((ND+1):end,:), [], 1);
    end
