% ===================== 中文教学注释 =====================
% 文件路径: Mesh Generation/Rotors/calculate_rotor1.m
% 教学提示: 请结合 docs/教学导读.md 中相应章节阅读本文件，以理解其作用和关键算法。
% ===================== 中文教学注释 =====================
function [p,t,m,FL,LL,ag] = calculate_rotor1(dim)
...
c = sqrt(line(5)^2+(dim.R_width2/2)^2-2*((line(5)+line(6))/2)*(dim.R_width2/2)*cosd(120)); 
alfa = asin((dim.R_width2/2*sind(120))/c);

%Init the Nodal coordinates and elements of the slot
