% ===================== 中文教学注释 =====================
% 文件路径: Mesh Generation/Rotors/calculate_rotor20.m
% 教学提示: 请结合 docs/教学导读.md 中相应章节阅读本文件，以理解其作用和关键算法。
% ===================== 中文教学注释 =====================
function [p,t,m,FL,LL,ag] = calculate_rotor20(dim)
...
dim.R_height1 = dim.Rout-0.5*(dim.Rout+dim.Rout-dim.R_height+dim.R_width2);
line = [dim.Rin 0.5*dim.Rin+0.5*(dim.Rout-dim.R_height) 0.25*dim.Rin+0.75*(dim.Rout-dim.R_height) ...
        ...
        dim.Rout-dim.R_height+dim.R_width2/2 dim.Rout-dim.R_height+dim.R_width2 dim.Rout-dim.R_height1 dim.Rout-dim.R_height1/2 ...
        dim.Rout];
...
c3 = sqrt(line(7)^2+(dim.R_width2/2)^2-2*line(7)*(dim.R_width2/2)*cosd(120));%135
alfa3 = asin((dim.R_width2/2*sind(120))/c3); %135
