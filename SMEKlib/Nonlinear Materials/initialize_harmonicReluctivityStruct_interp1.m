% ===================== 中文教学注释 =====================
% 文件路径: Nonlinear Materials/initialize_harmonicReluctivityStruct_interp1.m
% 教学提示: 请结合 docs/教学导读.md 中相应章节阅读本文件，以理解其作用和关键算法。
% ===================== 中文教学注释 =====================
function nu_struct = initialize_harmonicReluctivityStruct_interp1(msh, useDefaultMaterials, varargin)
...
if useDefaultMaterials
    N_defaultMats = get_defaultMaterials(-1); %number of default materials available
